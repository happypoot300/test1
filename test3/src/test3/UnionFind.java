...
//		setOfNodes.add(new Node(4));
		...
		myArrayList.add(new Node(0));
		myArrayList.add(new Node(1));
		myArrayList.add(new Node(2));
		myArrayList.add(new Node(3));
		myArrayList.add(new Node(4));
	}// end CONSTRUCTOR
...
//			setOfNodes.remove(findIndex(A));
			nodeA = myArrayList.get(findIndex(A));
			myArrayList.remove(findIndex(A));
			if (isInputAvailable(B)) {
//				nodeB = setOfNodes.get(findIndex(B));
//				setOfNodes.remove(findIndex(B));
				nodeB = myArrayList.get(findIndex(B));
				myArrayList.remove(findIndex(B));
...
//			if (setOfNodes.get(index).getDown() != null) {
			if (myArrayList.get(index).getDown() != null) {
//				if (deepSearch(setOfNodes.get(index), input)) {
				if (deepSearch(myArrayList.get(index), input)) {
					return index;
				} // end if
			} // end if

//			if (input == setOfNodes.get(index).getData()) {
			if (input == myArrayList.get(index).getData()) {
				return index;
			} // end if
		} // end for
...
//				return deepSearch(setOfNodes.get(index), input);
			if (myArrayList.get(index).getDown() != null) {
				return deepSearch(myArrayList.get(index), input);
			}
//			if (input == setOfNodes.get(index).getData()) {
			if (input == myArrayList.get(index).getData()) {
				return true;
...
//				Node tempNode = setOfNodes.get(index);
				Node tempNode = myArrayList.get(index);
				System.out.print("{ ");
				while (tempNode != null) {
...
//				System.out.print(setOfNodes.get(index).getData() + " ");
				System.out.print(myArrayList.get(index).getData() + " ");
			} // end if else
